...
<body>
  ...
  <header id="top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar" style="height: 65px;">
      <div class="container">
        <a class="navbar-brand" href="index.php"><strong>Title</strong></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent-7">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link font-weight-normal" href="index.php">Home</a>
            </li>
          ...
          <?php 
            if (isset($_SESSION['user_email'])) {
              ...
              <div class="mr-4 mt-3">
                <a href="customer.php">
                  <i class="fas fa-2x mr-3 fa-cart-arrow-down black-text" title="add property details" onmouseover=""></i>
                </a>
                <i class="far fa-2x fa-user-circle black-text" title="<?php echo $_SESSION['user_firstname'].' '.$_SESSION['user_lastname'];?>"></i><br>
          ...
          <div id="id02" class="popup-modal">
            <!-- Modal Content -->
            <form class="modal-content animate" method="POST" action="register.php" id="register-form">
              <div class="modal-header text-center">
    ...
    <!-- Navbar -->
    <!-- Full Page Intro -->
    <div class="view" style="background-image: url('img/building_4.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
      <div class="row front-search">
        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
          ...
          <div class="md-form animated fadeInDown delay-2s" role="group" >
            <form method="" action="">
              <input type="text" class="form-control location" aria-label="Search" placeholder="Search Location in Maharashtra" style="border:1px; width: 500px;height: 50px;background-color: white; text-align: center;">
            </form>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <div class="card wow fadeInLeft" data-wow-delay="0.6s">
          ...
          <!-- Card content -->
          <div class="card-body elegant-color white-text rounded-bottom" onmouseover="document.getElementByClassName('card-title').show()">
            <!-- Title -->
  ...
  <!-- More Information -->
  <div style="background-image: url('img/building_1.jpg'); height: 400px; background-size: cover;
  background-attachment: fixed;">
    <div class="info white-text">
      <h1 class="pt-4 info-head wow zoomIn" data-wow-delay="0.6s">MORE INFORMATION</h1>
      <p class="info-para wow fadeInUp" data-wow-delay="0.6s">
        "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."
      </p>
      <button class="info-btn wow fadeInRight" data-wow-delay="0.6s">GET STARTED</button>
    </div>
  </div>
  <!-- More Information -->
  ...
  <section class="team-section text-center my-5">
    ...
    <!-- Section description -->
    <p class="grey-text w-responsive mx-auto mb-5 wow fadeInLeft" data-wow-delay="0.6s">Lorem ipsum dolor sit amet, consectetur adipisicing elit.Fugit, error amet numquam iure provident voluptate esse quasi, veritatis totam voluptas nostrum quisquam
    ...
    <div class="row">
      ...
      <div class="col-lg-2 col-md-6 mb-lg-0 mb-5 wow fadeInLeft" data-wow-delay="0.6s">
        <div class="avatar mx-auto zoom">
          <img src="img/saurabh.jpg" class="rounded-circle z-depth-3"
      ...
      <div class="col-lg-2 col-md-6 mb-lg-0 mb-5 wow bounceInDown" data-wow-delay="0.6s">
        <div class="avatar mx-auto zoom">
          <img src="img/sagar.jpg" class="rounded-circle z-depth-3"
            alt="Sample avatar" style="width: 150px; height: 150px;">
        </div>
      ...
      <div class="col-lg-2 col-md-6 mb-md-0 mb-5 wow fadeInUp" data-wow-delay="0.6s">
        <div class="avatar mx-auto zoom">
          <img src="img/shantanu.jpg" class="rounded-circle z-depth-3"
            alt="Sample avatar" style="width: 150px; height: 150px;">
        </div>
      ...
      <div class="col-lg-2 col-md-6 wow fadeInRight" data-wow-delay="0.6s">
        <div class="avatar mx-auto zoom">
          <!-- <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(32).jpg" class="rounded-circle z-depth-3"
            alt="Sample avatar" style="width: 150px; height: 150px;"> -->
          <img src="img/pk2.png" class="rounded-circle z-depth-3"
            alt="Sample avatar" style="width: 150px; height: 150px;">
        </div>
  ...
  <footer class="page-footer font-small unique-color-dark">
    ...
    <div class="footer-copyright text-center py-3" style="padding: 0px 670px;">© 2018 Copyright:
      <a href="index.php" class="font-weight-normal"> Title.com</a>
    </div>
    <!-- Copyright -->
