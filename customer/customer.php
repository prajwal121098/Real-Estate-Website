...
if($_REQUEST['sub1'])
  ...
  {mysql_query("insert into bd values('$PNAME','$CTYPE','$PTYPE','$PAREA','$PUNIT','$FA','$AGE','$BATH')");}
...
if($_REQUEST['sub2'])
{mysql_query("insert into location values('$CNAME','$ADD')");}


if($_REQUEST['sub3'])
{
  mysql_query("insert into price values('$EP','$PPS','$BA')");       
}
$img=$f['name'];
   
if(mysql_query("insert into image values('$img')"))
{
...
<body>
  ...
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark unique-color-dark" style="height: 68px;">
    <a class="navbar-brand" href="../index/index.php">On-Estate</a>
  ...
  <div class="container mt-5" style="border:1px solid black;">
    ...
    <div class="row">
      <div class="tab">
          ...
          <button class="tablinks" onclick="openCity(event, 'Image_Upload')">
            <i class="fas fa-image mr-4"></i>Image Upload
          </button><button class="tablinks" onclick="openCity(event, 'Features')">
      ...
      <div class="tab-content">
        <div id="Basic Details" class="tabcontent ml-4">
          <form action="" method="POST">
            ...
            <div class="md-form">
              <input type="text" id="propertyname" class="form-control"  name="pn" id="pn">
            ...
            <div class="d-flex" style="border:1px solid grey; padding: 10px;">
              <div class="custom-control custom-radio mr-5" style="line-height: 2px;">
                <label class="type">
                  <input type="radio" name="p" value="Apartment" id="p">
              ...
              <div class="custom-control custom-radio mr-5" style="line-height: 3px;">
                <label class="type">
                  <input type="radio" name="p" value="Land" id="p">
              ...
              <div class="custom-control custom-radio mr-5" style="line-height: 2px;">
                <label class="type">
                  <input type="radio" name="p" value="Home" id="p">
                  <i class="fas fa-3x fa-home"></i><br>
            ...
            <div class="row mt-4">
              <div class="col-6" >
                <h6>Plot Area*:</h6>
                <div class="md-form">
                  <input type="number"  class="form-control" aria-describedby="passwordHelpBlockMD" name="pa" id="pa" >
              ...
              <div class="col-6">
                ...
                <div class="input-group mt-4">
                   <input type="text" id="propertyname" class="form-control" aria-describedby="passwordHelpBlockMD "  name="pu" id="pu">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-3">
                ...
                <div class="input-group mt-4">
                   <input type="text"  class="form-control" aria-describedby="passwordHelpBlockMD "  name="fa" id="fa">
                </div>
              </div>
              <div class="col-1"></div>
              <div class="col-3">
                ...
                <div class="input-group mt-4">
                   <input type="text" id="propertyname" class="form-control" aria-describedby="passwordHelpBlockMD "  name="age" id="age">
                </div>
              </div>
              <div class="col-1"></div>
              ...
              <div class="col-3">
                ...
                <div class="input-group mt-4">
                 <input type="text" id="propertyname" class="form-control" aria-describedby="passwordHelpBlockMD "  name="bath" id="bath">
                </div>
              </div>
            </div>
             <button type="submit" name="sub1" value="submit"  class="btn next-btn font-weight-bold float-right">NEXT</button>
        ...
        <div id="Pricing" class="tabcontent ml-4">
          <form method="POST" action="">
            ...
            <div class="md-form">
              <input type="number"  class="form-control" aria-describedby="passwordHelpBlockMD" name="ep" id="ep" style="width:30%;">
              <label for="ep" style="font-size: 12px;">Price</label>
            </div>
            <div class="row">
              <div class="col-6">
                <h6 class="mt-3">Price per sq.ft :</h6>
                <div class="md-form">
                  <input type="number" name="pps" id="pps" class="form-control" aria-describedby="passwordHelpBlockMD">
                  <label for="pps" style="font-size: 12px;">Price Sq.Ft.</label>
                </div>
              </div>
              <div class="col-6">
                <h6 class="mt-3">Booking Amount :</h6>
                <div class="md-form">
                  <input type="number" name="ba" id="ba" class="form-control" aria-describedby="passwordHelpBlockMD">
                  <label for="ba" style="font-size: 12px;">Booking Ammount</label>
                </div>
              </div>
            </div>    

            <button type="submit" name="sub" value="submit"class="btn next-btn font-weight-bold float-right">NEXT</button>
        ...
        <div id="Location" class="tabcontent ml-4">
          <form method="POST" action="">
            ...
            <div class="row">
              <div class="col-6">
                <div class="md-form">
                  <input type="text"  class="form-control" aria-describedby="passwordHelpBlockMD" name="c" id="c">
                  <label for="c">Enter City <i class="fas fa-map-marker-alt ml-1"></i></label>
                </div>
              </div>
              <div class="col-6">
                <div class="md-form">
            ...
            <div class="md-form">
              <input type="text"  class="form-control" aria-describedby="passwordHelpBlockMD " name="add" id="add">
              <label for="add">House no./Street Name</label>
            </div>
            <button type="submit" name="sub2" value="submit" class="btn next-btn font-weight-bold float-right">NEXT</button>
          </form> 
        </div>
        ...
        <div id="Pricing" class="tabcontent ml-4">
          <form method="POST" action="">
            ...
            <button  type="submit" name="sub3" value="submit" class="btn next-btn font-weight-bold float-right">NEXT</button>
          </form>
        </div>
        <div id="Image_Upload" class="tabcontent ml-4">
         
          <form action="customer.php" method="post" enctype="multipart/form-data">
            <div class="md-form">
              <input type="file" name="fileToUpload" id="fileToUpload" class="form-control" aria-describedby="passwordHelpBlockMD ">
            </div>  
